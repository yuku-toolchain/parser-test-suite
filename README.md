...
- `fail/` contains files that must produce a parse error. `ts/fail` is curated rather than synced, because the classifier cannot tell invalid TypeScript from TypeScript its oracle does not yet understand.
