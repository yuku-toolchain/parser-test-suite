...
const roc0 = Temporal.ZonedDateTime.from({
  era: "roc",
  eraYear: 0,
  monthCode: "M01",
  day: 1,
...
const roc1n = Temporal.ZonedDateTime.from({
  era: "roc",
  eraYear: -1,
  monthCode: "M01",
  day: 1,
...
const broc0 = Temporal.ZonedDateTime.from({
  era: "broc",
  eraYear: 0,
  monthCode: "M01",
  day: 1,
...
const broc1n = Temporal.ZonedDateTime.from({
  era: "broc",
  eraYear: -1,
  monthCode: "M01",
  day: 1,
