...
const common1Shevat = Temporal.PlainDateTime.from({
  year: 5783,
  monthCode: "M05",
  day: 1,
  hour: 12,
...
const common1Nisan = Temporal.PlainDateTime.from({
  year: 5783,
  monthCode: "M07",
  day: 1,
  hour: 12,
...
const leapShevat = Temporal.PlainDateTime.from({
  year: 5784,
  monthCode: "M05",
  day: 1,
  hour: 12,
...
const leapAdarI = Temporal.PlainDateTime.from({
  year: 5784,
  monthCode: "M05L",
  day: 1,
  hour: 12,
...
const leapAdarII = Temporal.PlainDateTime.from({
  year: 5784,
  monthCode: "M06",
  day: 1,
  hour: 12,
...
const common2Shevat = Temporal.PlainDateTime.from({
  year: 5785,
  monthCode: "M05",
  day: 1,
  hour: 12,
