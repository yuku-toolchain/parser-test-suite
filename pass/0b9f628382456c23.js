...
const reiwa = Temporal.PlainDateTime.from({
  era: "reiwa",
  eraYear: 2,
  month: 1,
  day: 1,
...
const heisei = Temporal.PlainDateTime.from({
  era: "heisei",
  eraYear: 2,
  month: 1,
  day: 1,
...
const showa = Temporal.PlainDateTime.from({
  era: "showa",
  eraYear: 2,
  month: 1,
  day: 1,
...
const taisho = Temporal.PlainDateTime.from({
  era: "taisho",
  eraYear: 2,
  month: 1,
  day: 1,
...
const meiji = Temporal.PlainDateTime.from({
  era: "meiji",
  eraYear: 6,
  month: 1,
  day: 1,
...
const ce = Temporal.PlainDateTime.from({
  era: "ce",
  eraYear: 1000,
  month: 1,
  day: 1,
...
const bce = Temporal.PlainDateTime.from({
  era: "bce",
  eraYear: 1,
  month: 1,
  day: 1,
