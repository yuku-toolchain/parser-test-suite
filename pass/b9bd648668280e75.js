...
TemporalHelpers.assertPlainDate(Temporal.PlainDate.from('2019-02-28').subtract({
  months: 1
}), 2019, 1, "M01", 28);
TemporalHelpers.assertPlainDate(date.subtract(Temporal.Duration.from('P43Y')), 1976, 11, "M11", 18);
TemporalHelpers.assertPlainDate(Temporal.PlainDate.from('1976-11-18').subtract({
  years: -43
}), 2019, 11, "M11", 18);
TemporalHelpers.assertPlainDate(Temporal.PlainDate.from('2018-12-18').subtract({
  months: -11
}), 2019, 11, "M11", 18);
TemporalHelpers.assertPlainDate(Temporal.PlainDate.from('2019-10-29').subtract({
  days: -20
}), 2019, 11, "M11", 18);
TemporalHelpers.assertPlainDate(Temporal.PlainDate.from('2019-01-28').subtract({
  months: -1
}), 2019, 2, "M02", 28);
