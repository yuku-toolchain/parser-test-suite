...
const common1Shevat = Temporal.PlainDate.from({
  year: 5783,
  monthCode: "M05",
  day: 1,
  calendar
...
const common1Nisan = Temporal.PlainDate.from({
  year: 5783,
  monthCode: "M07",
  day: 1,
  calendar
}, options);
const leapShevat = Temporal.PlainDate.from({
  year: 5784,
  monthCode: "M05",
  day: 1,
  calendar
}, options);
const leapAdarI = Temporal.PlainDate.from({
  year: 5784,
  monthCode: "M05L",
  day: 1,
  calendar
}, options);
const leapAdarII = Temporal.PlainDate.from({
  year: 5784,
  monthCode: "M06",
  day: 1,
  calendar
}, options);
const common2Shevat = Temporal.PlainDate.from({
  year: 5785,
  monthCode: "M05",
  day: 1,
  calendar
