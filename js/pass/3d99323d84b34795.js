...
const expected = [["years", [6], [-6]], ["months", [5, 8], [-5, -8]], ["weeks", [5, 7, 4], [-5, -7, -4]], ["days", [5, 7, 0, 28], [-5, -7, 0, -28]], ["hours", [5, 7, 0, 27, 17], [-5, -7, 0, -27, -17]], ["minutes", [5, 7, 0, 27, 16, 30], [-5, -7, 0, -27, -16, -30]], ["seconds", [5, 7, 0, 27, 16, 30, 20], [-5, -7, 0, -27, -16, -30, -20]], ["milliseconds", [5, 7, 0, 27, 16, 30, 20, 124], [-5, -7, 0, -27, -16, -30, -20, -124]], ["microseconds", [5, 7, 0, 27, 16, 30, 20, 123, 987], [-5, -7, 0, -27, -16, -30, -20, -123, -987]], ["nanoseconds", [5, 7, 0, 27, 16, 30, 20, 123, 987, 500], [-5, -7, 0, -27, -16, -30, -20, -123, -987, -500]]];
...
expected.forEach(([smallestUnit, expectedPositive, expectedNegative]) => {
  ...
  TemporalHelpers.assertDuration(instance.round({
    smallestUnit,
    relativeTo: relativeToForwards,
    roundingMode
  }), py, pm, pw, pd, ph, pmin, ps, pms, pµs, pns, `rounds to ${smallestUnit} (roundingMode = ${roundingMode}, positive case)`);
  TemporalHelpers.assertDuration(instance.negated().round({
    smallestUnit,
    relativeTo: relativeToBackwards,
    roundingMode
  }), ny, nm, nw, nd, nh, nmin, ns, nms, nµs, nns, `rounds to ${smallestUnit} (rounding mode = ${roundingMode}, negative case)`);
});