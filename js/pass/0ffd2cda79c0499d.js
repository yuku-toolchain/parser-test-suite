const matchSymbols = buildString({
  loneCodePoints: [],
  ranges: [[0x000F00, 0x000F47], [0x000F49, 0x000F6C], [0x000F71, 0x000F97], [0x000F99, 0x000FBC], [0x000FBE, 0x000FCC], [0x000FCE, 0x000FD4], [0x000FD9, 0x000FDA]]
});
...
const nonMatchSymbols = buildString({
  ...
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x000EFF], [0x000F6D, 0x000F70], [0x000FD5, 0x000FD8], [0x000FDB, 0x00DBFF], [0x00E000, 0x10FFFF]]
});
