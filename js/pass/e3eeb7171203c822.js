...
const bh5 = Temporal.PlainDateTime.from({
  era: "bh",
  eraYear: 5,
  monthCode: "M06",
  day: 15,
...
const bh2 = Temporal.PlainDateTime.from({
  era: "bh",
  eraYear: 2,
  monthCode: "M12",
  day: 1,
...
const bh1 = Temporal.PlainDateTime.from({
  era: "bh",
  eraYear: 1,
  monthCode: "M06",
  day: 15,
...
const ah1 = Temporal.PlainDateTime.from({
  era: "ah",
  eraYear: 1,
  monthCode: "M06",
  day: 15,
...
const ah2 = Temporal.PlainDateTime.from({
  era: "ah",
  eraYear: 2,
  monthCode: "M01",
  day: 1,
...
const ah5 = Temporal.PlainDateTime.from({
  era: "ah",
  eraYear: 5,
  monthCode: "M06",
  day: 15,
