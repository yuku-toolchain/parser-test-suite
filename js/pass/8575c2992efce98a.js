...
const broc5 = Temporal.ZonedDateTime.from({
  era: "broc",
  eraYear: 5,
  monthCode: "M03",
  day: 1,
...
const broc3 = Temporal.ZonedDateTime.from({
  era: "broc",
  eraYear: 3,
  monthCode: "M01",
  day: 1,
...
const broc1 = Temporal.ZonedDateTime.from({
  era: "broc",
  eraYear: 1,
  monthCode: "M06",
  day: 1,
...
const roc1 = Temporal.ZonedDateTime.from({
  era: "roc",
  eraYear: 1,
  monthCode: "M06",
  day: 1,
...
const roc5 = Temporal.ZonedDateTime.from({
  era: "roc",
  eraYear: 5,
  monthCode: "M03",
  day: 1,
...
const roc10 = Temporal.ZonedDateTime.from({
  era: "roc",
  eraYear: 10,
  monthCode: "M01",
  day: 1,
