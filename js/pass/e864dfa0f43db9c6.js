...
const common1Month4 = Temporal.PlainDate.from({
  year: 2000,
  monthCode: "M04",
  day: 1,
  calendar
}, options);
const common1Month5 = Temporal.PlainDate.from({
  year: 2000,
  monthCode: "M05",
  day: 1,
  calendar
}, options);
const common1Month6 = Temporal.PlainDate.from({
  year: 2000,
  monthCode: "M06",
  day: 1,
  calendar
}, options);
const leapMonth4 = Temporal.PlainDate.from({
  year: 2001,
  monthCode: "M04",
  day: 1,
  calendar
}, options);
const leapMonth4L = Temporal.PlainDate.from({
  year: 2001,
  monthCode: "M04L",
  day: 1,
  calendar
}, options);
const leapMonth5 = Temporal.PlainDate.from({
  year: 2001,
  monthCode: "M05",
  day: 1,
  calendar
}, options);
const common2Month4 = Temporal.PlainDate.from({
  year: 2002,
  monthCode: "M04",
  day: 1,
  calendar
}, options);
const common2Month5 = Temporal.PlainDate.from({
  year: 2002,
  monthCode: "M05",
  day: 1,
  calendar
