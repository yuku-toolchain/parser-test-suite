...
const reiwa = Temporal.PlainDate.from({
  era: "reiwa",
  eraYear: 2,
  month: 1,
  day: 1,
...
const heisei = Temporal.PlainDate.from({
  era: "heisei",
  eraYear: 2,
  month: 1,
  day: 1,
...
const showa = Temporal.PlainDate.from({
  era: "showa",
  eraYear: 2,
  month: 1,
  day: 1,
...
const taisho = Temporal.PlainDate.from({
  era: "taisho",
  eraYear: 2,
  month: 1,
  day: 1,
...
const meiji = Temporal.PlainDate.from({
  era: "meiji",
  eraYear: 6,
  month: 1,
  day: 1,
...
const ce = Temporal.PlainDate.from({
  era: "ce",
  eraYear: 1000,
  month: 1,
  day: 1,
...
const bce = Temporal.PlainDate.from({
  era: "bce",
  eraYear: 1,
  month: 1,
  day: 1,
