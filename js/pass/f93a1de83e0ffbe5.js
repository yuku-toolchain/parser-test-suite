...
TemporalHelpers.assertPlainTime(t1.subtract(Temporal.Duration.from({
...
TemporalHelpers.assertPlainTime(t2.subtract(Temporal.Duration.from({
  nanoseconds: bigNumber
})), 0, 12, 25, 259, 9, 24);
TemporalHelpers.assertPlainTime(t2.subtract(Temporal.Duration.from({
  nanoseconds: -bigNumber
