...
const ah0 = Temporal.PlainYearMonth.from({
  era: "ah",
  eraYear: 0,
  monthCode: "M01",
  calendar
...
const ah1n = Temporal.PlainYearMonth.from({
  era: "ah",
  eraYear: -1,
  monthCode: "M01",
  calendar
...
const bh0 = Temporal.PlainYearMonth.from({
  era: "bh",
  eraYear: 0,
  monthCode: "M01",
  calendar
...
const bh1n = Temporal.PlainYearMonth.from({
  era: "bh",
  eraYear: -1,
  monthCode: "M01",
  calendar
