...
TemporalHelpers.assertDuration(a.until(b, {
  largestUnit: 'years'
...
TemporalHelpers.assertDuration(c.until(d, {
  largestUnit: 'years'
...
TemporalHelpers.assertDuration(e.until(f, {
  largestUnit: 'years'
...
TemporalHelpers.assertDuration(g.until(h, {
  largestUnit: 'years'
