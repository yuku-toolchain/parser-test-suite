...
TemporalHelpers.assertDuration(theFuture.since(thePast, {
  largestUnit: 'years'
}), 35, 2, 0, 15, 1, 56, 51, 111, 111, 101, 'does not include higher units than necessary (largest unit is years)');
TemporalHelpers.assertDuration(theFuture.since(thePast, {
  largestUnit: 'months'
}), 0, 422, 0, 15, 1, 56, 51, 111, 111, 101, 'does not include higher units than necessary (largest unit is months)');
TemporalHelpers.assertDuration(theFuture.since(thePast, {
  largestUnit: 'weeks'
}), 0, 0, 1837, 1, 1, 56, 51, 111, 111, 101, 'does not include higher units than necessary (largest unit is weeks)');
TemporalHelpers.assertDuration(theFuture.since(thePast, {
  largestUnit: 'days'
}), 0, 0, 0, 12860, 1, 56, 51, 111, 111, 101, 'does not include higher units than necessary (largest unit is days)');
TemporalHelpers.assertDuration(theFuture.since(thePast, {
  largestUnit: 'hours'
