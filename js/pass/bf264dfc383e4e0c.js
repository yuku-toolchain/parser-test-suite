...
}
{
  ...
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    ...
    largestUnit: "months"
  }), 0, 27, 0, 30, 0, 0, 0, 0, 0, 0, "Dec 30th 1970 to Apr 30th 1973 is 27 months, 30 days, not 28 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 1970,
    monthCode: "M12",
    day: 31,
    ...
    largestUnit: "years"
  }), 2, 3, 0, 30, 0, 0, 0, 0, 0, 0, "Dec 30th 1970 to Apr 30th 1973 is 2 years, 3 months, 30 days, not 2 years 4 months");
}
{
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 1970,
