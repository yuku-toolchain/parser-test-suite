...
const bce5 = Temporal.ZonedDateTime.from({
  era: "bce",
  eraYear: 5,
  monthCode: "M06",
  day: 15,
...
const bce2 = Temporal.ZonedDateTime.from({
  era: "bce",
  eraYear: 2,
  monthCode: "M12",
  day: 1,
...
const ce2 = Temporal.ZonedDateTime.from({
  era: "ce",
  eraYear: 2,
  monthCode: "M01",
  day: 1,
...
const ce5 = Temporal.ZonedDateTime.from({
  era: "ce",
  eraYear: 5,
  monthCode: "M06",
  day: 15,
