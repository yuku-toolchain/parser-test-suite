const matchSymbols = buildString({
  ...
  ranges: [[0x000660, 0x000669], [0x010E80, 0x010EA9], [0x010EAB, 0x010EAD], [0x010EB0, 0x010EB1]]
});
...
const nonMatchSymbols = buildString({
  loneCodePoints: [0x010EAA],
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x00060B], [0x00060D, 0x00061A], [0x00061C, 0x00061E], [0x000620, 0x00065F], [0x00066A, 0x00DBFF], [0x00E000, 0x010E7F], [0x010EAE, 0x010EAF], [0x010EB2, 0x10FFFF]]
});
