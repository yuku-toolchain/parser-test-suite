...
TemporalHelpers.assertDuration(feb_1_2021.since(feb_1_2020, {
  largestUnit: "auto"
}), 0, 0, 0, 366, 0, 0, 0, 0, 0, 0, "defaults to returning days (largest unit = auto)");
TemporalHelpers.assertDuration(feb_1_2021.since(feb_1_2020, {
  largestUnit: "days"
}), 0, 0, 0, 366, 0, 0, 0, 0, 0, 0, "defaults to returning days (largest unit = days)");
