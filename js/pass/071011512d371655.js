const matchSymbols = buildString({
  ...
  ranges: [[0x010B80, 0x010B91], [0x010B99, 0x010B9C], [0x010BA9, 0x010BAF]]
});
...
const nonMatchSymbols = buildString({
  loneCodePoints: [],
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x00063F], [0x000641, 0x00DBFF], [0x00E000, 0x010B7F], [0x010B92, 0x010B98], [0x010B9D, 0x010BA8], [0x010BB0, 0x10FFFF]]
});
