const matchSymbols = buildString({
  loneCodePoints: [0x0000B7, 0x000300, 0x000313, 0x000483],
  ranges: [[0x000306, 0x000308], [0x010350, 0x01037A]]
});
...
const nonMatchSymbols = buildString({
  loneCodePoints: [],
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x0000B6], [0x0000B8, 0x0002FF], [0x000301, 0x000305], [0x000309, 0x000312], [0x000314, 0x000482], [0x000484, 0x00DBFF], [0x00E000, 0x01034F], [0x01037B, 0x10FFFF]]
});
