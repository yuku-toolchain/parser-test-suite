...
TemporalHelpers.assertDuration(lastFeb21.since(lastFeb20, {
  largestUnit: 'months'
}), 0, 12, 0, 1, 11, 33, 37, 0, 0, 0, 'does not include higher units than necessary (largest unit is months)');
TemporalHelpers.assertDuration(lastFeb21.since(lastFeb20, {
  largestUnit: 'years'
}), 1, 0, 0, 1, 11, 33, 37, 0, 0, 0, 'does not include higher units than necessary (largest unit is years)');