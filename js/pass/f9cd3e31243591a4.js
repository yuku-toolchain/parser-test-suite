...
}
{
  ...
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    ...
    largestUnit: "months"
  }), 0, 28, 0, 0, 0, 0, 0, 0, 0, 0, "Dec 30th 1970 to Apr 30th 1973 is 28 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 1970,
    monthCode: "M12",
    day: 30,
    ...
    largestUnit: "years"
  }), 2, 4, 0, 0, 0, 0, 0, 0, 0, 0, "Dec 30th 1970 to Apr 30th 1973 is 2 years, 4 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 1970,
    monthCode: "M12",
    day: 31,
    ...
    largestUnit: "months"
  }), 0, 27, 0, 30, 0, 0, 0, 0, 0, 0, "Dec 31st 1970 to Apr 30th 1973 is 27 months, 30 days, not 28 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 1970,
    monthCode: "M12",
    day: 31,
    ...
    largestUnit: "years"
  }), 2, 3, 0, 30, 0, 0, 0, 0, 0, 0, "Dec 31st 1970 to Apr 30th 1973 is 2 years, 3 months, 30 days, not 2 years 4 months");
}
{
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 1970,
  ...
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    ...
    largestUnit: "years"
  }), 1, 3, 0, 30, 0, 0, 0, 0, 0, 0, "Jan 31st 1970 to May 30th 1971 is 1 year, 3 months, 30 days, not 1 year, 2 months, 60 days");
}