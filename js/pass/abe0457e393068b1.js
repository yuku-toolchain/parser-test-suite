const matchSymbols = buildString({
  loneCodePoints: [0x0030FB],
  ranges: [[0x003001, 0x003002], [0x003008, 0x003011], [0x003014, 0x00301B], [0x00A000, 0x00A48C], [0x00A490, 0x00A4C6], [0x00FF61, 0x00FF65]]
});
...
const nonMatchSymbols = buildString({
  loneCodePoints: [],
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x003000], [0x003003, 0x003007], [0x003012, 0x003013], [0x00301C, 0x0030FA], [0x0030FC, 0x009FFF], [0x00A48D, 0x00A48F], [0x00A4C7, 0x00DBFF], [0x00E000, 0x00FF60], [0x00FF66, 0x10FFFF]]
});
