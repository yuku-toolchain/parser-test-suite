const matchSymbols = buildString({
  ...
  ranges: [[0x010800, 0x010805], [0x01080A, 0x010835], [0x010837, 0x010838]]
});
...
const nonMatchSymbols = buildString({
  ...
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x00DBFF], [0x00E000, 0x0107FF], [0x010806, 0x010807], [0x010839, 0x01083B], [0x01083D, 0x01083E], [0x010840, 0x10FFFF]]
});
