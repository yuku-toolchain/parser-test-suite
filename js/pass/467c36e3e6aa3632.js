...
}
{
  ...
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    ...
    largestUnit: "months"
  }), 0, 28, 0, 0, 0, 0, 0, 0, 0, 0, "Dec 30th 2520 to Apr 30th 2523 is 28 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 2520,
    monthCode: "M12",
    day: 30,
    ...
    largestUnit: "years"
  }), 2, 4, 0, 0, 0, 0, 0, 0, 0, 0, "Dec 30th 2520 to Apr 30th 2523 is 2 years, 4 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 2520,
    monthCode: "M12",
    day: 31,
    ...
    largestUnit: "months"
  }), 0, 27, 0, 30, 0, 0, 0, 0, 0, 0, "Dec 30th 2520 to Apr 30th 2523 is 27 months, 30 days, not 28 months");
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 2520,
    monthCode: "M12",
    day: 31,
    ...
    largestUnit: "years"
  }), 2, 3, 0, 30, 0, 0, 0, 0, 0, 0, "Dec 30th 2520 to Apr 30th 2523 is 2 years, 3 months, 30 days, not 2 years 4 months");
}
{
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    year: 2520,
  ...
  TemporalHelpers.assertDuration(Temporal.PlainDateTime.from({
    ...
    largestUnit: "years"
  }), 1, 3, 0, 30, 0, 0, 0, 0, 0, 0, "Jan 31st 2520 to May 30th 2521 is 1 year, 3 months, 30 days, not 1 year, 2 months, 60 days");
}