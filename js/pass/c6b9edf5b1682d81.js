...
const am0 = Temporal.PlainYearMonth.from({
  era: "am",
  eraYear: 0,
  monthCode: "M01",
  calendar
...
const am1n = Temporal.PlainYearMonth.from({
  era: "am",
  eraYear: -1,
  monthCode: "M01",
  calendar
...
const aa0 = Temporal.PlainYearMonth.from({
  era: "aa",
  eraYear: 0,
  monthCode: "M01",
  calendar
...
const aa1n = Temporal.PlainYearMonth.from({
  era: "aa",
  eraYear: -1,
  monthCode: "M01",
  calendar
