...
const reiwa = Temporal.PlainYearMonth.from({
  era: "reiwa",
  eraYear: 2,
  month: 1,
  calendar
});
const heisei = Temporal.PlainYearMonth.from({
  era: "heisei",
  eraYear: 2,
  month: 1,
  calendar
});
const showa = Temporal.PlainYearMonth.from({
  era: "showa",
  eraYear: 2,
  month: 1,
  calendar
});
const taisho = Temporal.PlainYearMonth.from({
  era: "taisho",
  eraYear: 2,
  month: 1,
  calendar
});
const meiji = Temporal.PlainYearMonth.from({
  era: "meiji",
  eraYear: 6,
  month: 1,
  calendar
});
const ce = Temporal.PlainYearMonth.from({
  era: "ce",
  eraYear: 1000,
  month: 1,
  calendar
});
const bce = Temporal.PlainYearMonth.from({
  era: "bce",
  eraYear: 1,
  month: 1,
  calendar
