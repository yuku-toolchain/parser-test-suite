const matchSymbols = buildString({
  loneCodePoints: [0x000965, 0x001940],
  ranges: [[0x001900, 0x00191E], [0x001920, 0x00192B], [0x001930, 0x00193B], [0x001944, 0x00194F]]
});
...
const nonMatchSymbols = buildString({
  loneCodePoints: [0x00191F],
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x000964], [0x000966, 0x0018FF], [0x00192C, 0x00192F], [0x00193C, 0x00193F], [0x001941, 0x001943], [0x001950, 0x00DBFF], [0x00E000, 0x10FFFF]]
});
