const matchSymbols = buildString({
  loneCodePoints: [0x00A9CF],
  ranges: [[0x001A00, 0x001A1B], [0x001A1E, 0x001A1F]]
});
...
const nonMatchSymbols = buildString({
  loneCodePoints: [],
  ranges: [[0x00DC00, 0x00DFFF], [0x000000, 0x0019FF], [0x001A1C, 0x001A1D], [0x001A20, 0x00A9CE], [0x00A9D0, 0x00DBFF], [0x00E000, 0x10FFFF]]
});
