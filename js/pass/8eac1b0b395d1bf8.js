...
TemporalHelpers.assertPlainTime(plainTime.subtract({
  hours: 16
...
TemporalHelpers.assertPlainTime(Temporal.PlainTime.from("23:23:30.123456789").subtract({
  hours: -16
}), 15, 23, 30, 123, 456, 789, "subtract -16 hours across midnight boundary");
TemporalHelpers.assertPlainTime(Temporal.PlainTime.from("14:38:30.123456789").subtract({
  minutes: -45
}), 15, 23, 30, 123, 456, 789, "subtract -45 minutes");
TemporalHelpers.assertPlainTime(Temporal.PlainTime.from("15:22:45.123456789").subtract({
  seconds: -45
}), 15, 23, 30, 123, 456, 789, "subtract -45 seconds");
TemporalHelpers.assertPlainTime(Temporal.PlainTime.from("15:23:29.323456789").subtract({
  milliseconds: -800
}), 15, 23, 30, 123, 456, 789, "subtract -800 milliseconds");
TemporalHelpers.assertPlainTime(Temporal.PlainTime.from("15:23:30.122656789").subtract({
  microseconds: -800
}), 15, 23, 30, 123, 456, 789, "subtract -800 microseconds");
TemporalHelpers.assertPlainTime(Temporal.PlainTime.from("15:23:30.123455989").subtract({
  nanoseconds: -800
